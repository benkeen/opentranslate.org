 ...
 * 		This code has no affiliation with Google (TM), it's a PHP Library that allows to comunicate with public a API
 *
...
//	  private $url = "http://ajax.googleapis.com/ajax/services/language/translate";
	   ...
	   * @var string
	   */
	  private $api_key = "AIzaSyCrkl7BoiKPc5Kero35JCn7KilIFx-AWUg";
...
*/		
  ...
  /**
   * Magic method to understand translation comman
   ...
   * @param String $from the two character language representation of the source language
   * @param String $to the two character language representation of the target language
   * @param String $string the string to translate
   * @return String $response the translated text
